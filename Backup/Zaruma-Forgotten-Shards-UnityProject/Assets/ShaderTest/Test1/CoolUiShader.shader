Shader "Custom/CoolUiShader"
{
    Properties
    {
        ...
        _DistortionSpreader ("Distortion Spredder", Float) = 100 
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                tex2D(_NoiseTex, float2(IN.worldPosition.y / _DistortionSpreader, _Time[1] / 10)).r, 
                tex2D(_NoiseTex, float2(_Time[1] / 10, IN.worldPosition.x / _DistortionSpreader)).r);
